...
public class ImageCacheManager extends KVCache<String, Bitmap> {
     ...
     * { #setCompressFormat(Bitmap.CompressFormat)} to set format, then using
     * { #put(String, Bitmap)} to put bitmap into cache, then set
    ...
    protected void toLocalDisk(String key, Bitmap value, OutputStream os) {
        value.compress(Bitmap.CompressFormat.JPEG, mQuality, os);
    }

    protected void toLocalDiskWithPng(String key, Bitmap value, OutputStream os) {
        value.compress(Bitmap.CompressFormat.PNG, mQuality, os);
    }
    ...
    public void setCompressFormat(Bitmap.CompressFormat mCompressFormat) {
