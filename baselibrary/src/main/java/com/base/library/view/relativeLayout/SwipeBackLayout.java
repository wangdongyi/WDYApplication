package com.base.library.view.relativeLayout;//Created by 王东一 on 2016/9/1.
...
import com.base.library.util.ECHandlerHelper;
import com.base.library.util.MethodInvoke;
import com.base.library.util.SDKVersionUtils;
import com.base.library.util.SwipTranslucentMethodUtils;
...
public class SwipeBackLayout extends RelativeLayout {
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        ...
        if (Float.compare(mScrimOpacity, 0.0F) > 0 && drawContent && mDragHelper.getViewDragState() != ViewDragHelper.STATE_IDLE) {
