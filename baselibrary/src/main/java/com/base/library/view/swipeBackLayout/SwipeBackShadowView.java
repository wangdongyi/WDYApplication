...
public class SwipeBackShadowView extends FrameLayout {
    ...
    private Bitmap getBitmap(View view) {
        ...
        Bitmap bitmap = Bitmap.createBitmap(view.getDrawingCache(), 0, 0,
                CodeUtil.getScreenWidth(mActivity),
                CodeUtil.getScreenHeight(mActivity) - CodeUtil.getNavigationBarHeight(mActivity));
    ...
    private void onPanelSlide(Activity currentActivity, float slideOffset) {
        try {
            ...
            if (preActivity != null) {
                ...
                decorView.setTranslationX(-(decorView.getMeasuredWidth() / 3.0f) * (1 - slideOffset));
