...
public class CircularProgressButton extends Button {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        mStrokeWidth = CodeUtil.dip2px(context, 4);
    ...
    public void ShowError() {
        ...
        postDelayed(new Runnable() {
            @Override
            public void run() {
                setProgress(CircularProgressButton.ERROR_STATE_PROGRESS);
            }
        }, 500);
    }
    ...
    public void ShowSuccess() {
        ...
        postDelayed(new Runnable() {
            @Override
            public void run() {
                setProgress(CircularProgressButton.SUCCESS_STATE_PROGRESS);
            }
        }, 500);
    }
    ...
    private StrokeGradientDrawable createDrawable(int color) {
        GradientDrawable drawable = (GradientDrawable) ResourcesCompat.getDrawable(getResources(), R.drawable.cpb_background, null).mutate();
