package com.base.library.view.textView;
...
/**
 * Created by wangdongyi on 2016/12/27.
 */

public class WdyTextView extends TextView {
    ...
    public WdyTextView(Context context) {
        this(context, null);
    }

    public WdyTextView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WdyTextView(Context context, AttributeSet attrs, int defStyleAttr) {
