...
import com.base.library.view.photoView.gestures.OnGestureListener;
import com.base.library.view.photoView.gestures.VersionedGestureDetector;
import com.base.library.view.photoView.scrollerproxy.ScrollerProxy;
...
public class PhotoViewAttacher implements IPhotoView, View.OnTouchListener, OnGestureListener, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private com.base.library.view.photoView.gestures.GestureDetector mScaleDragDetector;
    ...
    public ImageView getImageView() {
        ...
        if (null == imageView) {
            cleanup();
            WDYLog.i(LOG_TAG, "ImageView no longer exists. You should not use this PhotoViewAttacher any more.");
        }
    ...
    public void onDrag(float dx, float dy) {
        ...
        if (DEBUG) {
            WDYLog.d(LOG_TAG, String.format("onDrag: dx: %.2f. dy: %.2f", dx, dy));
        }
    ...
    public void onFling(float startX, float startY, float velocityX, float velocityY) {
        if (DEBUG) {
            WDYLog.d(LOG_TAG, "onFling. sX: " + startX + " sY: " + startY + " Vx: " + velocityX + " Vy: " + velocityY);
        }
        ImageView imageView = getImageView();
    ...
    public void onScale(float scaleFactor, float focusX, float focusY) {
        if (DEBUG) {
            WDYLog.d(LOG_TAG, String.format("onScale: scale: %.2f. fX: %.2f. fY: %.2f", scaleFactor, focusX, focusY));
        }
            ...
            switch (ev.getAction()) {
                case ACTION_DOWN:
                    ...
                    if (null != parent)
                        ...
                        WDYLog.i(LOG_TAG, "onTouch getParent() returned null");
    ...
    public void setScale(float scale, float focalX, float focalY,
        ...
        if (null != imageView) {
            ...
            if (scale < mMinScale || scale > mMaxScale) {
                WDYLog.i(LOG_TAG, "Scale must be within the range of minScale and maxScale");
                return;
            }
    ...
    private class FlingRunnable implements Runnable {
        ...
        public void fling(int viewWidth, int viewHeight, int velocityX, int velocityY) {
            ...
            if (DEBUG) {
                WDYLog.d(LOG_TAG, "fling. StartX:" + startX + " StartY:" + startY + " MaxX:" + maxX + " MaxY:" + maxY);
            }
        ...
        public void run() {
            ...
            if (null != imageView && mScroller.computeScrollOffset()) {
                ...
                if (DEBUG) {
                    WDYLog.d(LOG_TAG, "fling run(). CurrentX:" + mCurrentX + " CurrentY:" + mCurrentY + " NewX:" + newX + " NewY:" + newY);
                }
