...
import com.base.library.view.wheel.adapter.WheelViewAdapter;

import java.util.LinkedList;
import java.util.List;

/**
 * 作者：王东一 on 2016/5/19 17:55
 **/
public class WheelView extends View {
     ...
     */
    private static final int[] SHADOWS_COLORS = new int[]{0x00000000, 0x00AAAAAA, 0x00EEEEEE};
