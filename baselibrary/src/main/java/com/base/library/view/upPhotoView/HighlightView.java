...
public class HighlightView {
     ...
     */
    private void init() {
        mResizeDrawableDiagonal = DoPicCapUtil.bitmapToDrawable(DoPicCapUtil.getBitmapFormSrc("image/crop_big.png"));
        mResizeDrawableDiagonal2 = DoPicCapUtil.bitmapToDrawable(DoPicCapUtil.getBitmapFormSrc("image/crop_small.png"));
    }
