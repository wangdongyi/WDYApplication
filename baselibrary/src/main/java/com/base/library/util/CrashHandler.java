...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    private final static String TAG = "WDY.UncaughtException";
    /** CrashHandler实例 */
    ...
    private boolean handleException(Throwable ex) {
        if (ex == null) {
            WDYLog.w(TAG, "handleException --- ex==null");
            return true;
        }
...
//        }.start();
    ...
    private String saveCrashInfoToFile(Throwable ex) {
        ...
        try {
            ...
            if (CodeUtil.isExitsSdcard()) {
                File dir = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/Wdy");
                if (!dir.exists()) {
                    dir.mkdirs();
                }
            ...
            WDYLog.e(TAG, "an error occured while writing report file..." + e.getMessage());
        }
        return null;
    }
    ...
    public void collectCrashDeviceInfo(Context ctx) {
        try {
            ...
            WDYLog.e(TAG, "Error while collect package info" + e.getMessage());
        }
        ...
        for (Field field : fields) {
            try {
                ...
                WDYLog.e(TAG, "Error while collect crash info" + e.getMessage());
            }
        }
    }
