...
import com.base.library.photopicker.widgets.SquareImageView;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        switch (getItemViewType(position)) {
            case TYPE_CAMERA:
                ...
                break;
            case TYPE_PHOTO:
                viewHolder.viewHolderPhoto.photoImageView.setImageResource(R.drawable.default_picture);
            ...
            public void onClick(View v) {
                ...
                if (mSelectedPhotos.contains(path)) {
                    ...
                    if (mSelectedPhotos.size() >= mMaxNum) {
                        BaseApplication.getToastUtil().showMiddleToast(mContext.getString(R.string.picker_msg_maxi_capacity));
                        return;
                    }
