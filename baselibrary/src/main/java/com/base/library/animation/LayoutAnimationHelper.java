...
public class LayoutAnimationHelper {
    ...
    public static void setTime(int time) {
        LayoutAnimationHelper.time = time;
    }
    ...
    public static AnimationSet getAnimationSetFromLeft() {
        ...
        TranslateAnimation translateX1 = new TranslateAnimation(RELATIVE_TO_SELF, -1.0f, RELATIVE_TO_SELF, 0.1f, RELATIVE_TO_SELF, 0, RELATIVE_TO_SELF, 0);
        translateX1.setDuration(300);
        translateX1.setInterpolator(new DecelerateInterpolator());
        translateX1.setStartOffset(0);

        TranslateAnimation translateX2 = new TranslateAnimation(RELATIVE_TO_SELF, 0.1f, RELATIVE_TO_SELF, -0.1f, RELATIVE_TO_SELF, 0, RELATIVE_TO_SELF, 0);
        translateX2.setStartOffset(300);
        translateX2.setInterpolator(new DecelerateInterpolator());
        translateX2.setDuration(50);

        TranslateAnimation translateX3 = new TranslateAnimation(RELATIVE_TO_SELF, -0.1f, RELATIVE_TO_SELF, 0f, RELATIVE_TO_SELF, 0, RELATIVE_TO_SELF, 0);
    ...
    public static AnimationSet getAnimationSetFromBottom() {
        AnimationSet animationSet = new AnimationSet(true);
        TranslateAnimation translateX1 = new TranslateAnimation(RELATIVE_TO_SELF, 0, RELATIVE_TO_SELF, 0, RELATIVE_TO_SELF, 10f, RELATIVE_TO_SELF, 0);
        translateX1.setDuration(getTime());
        translateX1.setInterpolator(new DecelerateInterpolator());
        translateX1.setStartOffset(0);

        animationSet.addAnimation(translateX1);
        animationSet.setDuration(getTime());
    ...
    public static AnimationSet getAnimationSetScaleBig() {
        ...
        scaleAnimation.setDuration(getTime());
    ...
    public static AnimationSet getAnimationSetAlpha() {
        ...
        alphaAnimation.setDuration(getTime());
    ...
    public static AnimationSet getAnimationSetRotation() {
        ...
        rotateAnimation.setDuration(getTime());
