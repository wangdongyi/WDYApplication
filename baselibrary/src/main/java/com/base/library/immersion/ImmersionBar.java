package com.base.library.immersion;
...
public class ImmersionBar {
    ...
    private void initParams(Activity activity, String name) {
        ...
        if (mMap.get(name) == null) {
            ...
            if (mFragmentName != null && (Build.VERSION.SDK_INT == Build.VERSION_CODES.KITKAT || OSUtils.isEMUI3_1())) { //保证一个activity页面有同一个状态栏view和导航栏view
