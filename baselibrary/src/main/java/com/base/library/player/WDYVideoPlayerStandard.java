...
public class WDYVideoPlayerStandard extends WDYVideoPlayer {
    ...
    public WDYVideoPlayerStandard(Context context) {
        super(context);
    }

    public WDYVideoPlayerStandard(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void setUp(String url, int screen, Object... objects) {
        ...
        if (currentScreen == SCREEN_WINDOW_FULLSCREEN) {
            ...
            changeStartButtonSize((int) getResources().getDimension(R.dimen.player_start_button_w_h_fullscreen));
            ...
            tinyBackImageView.setVisibility(View.INVISIBLE);
            changeStartButtonSize((int) getResources().getDimension(R.dimen.player_start_button_w_h_normal));
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (!mChangePosition && !mChangeVolume) {
                        onEvent(WDYUserActionStandard.ON_CLICK_BLANK);
                        onClickUiToggle();
                    }
                    break;
            }
    ...
    public void startVideo() {
        prepareMediaPlayer();
        onEvent(WDYUserActionStandard.ON_CLICK_START_THUMB);
    }
    ...
    public void showProgressDialog(float deltaX, String seekTime, int seekTimePosition, String totalTime, int totalTimeDuration) {
        ...
        if (mProgressDialog == null) {
            View localView = LayoutInflater.from(getContext()).inflate(R.layout.player_dialog_progress, null);
            mDialogProgressBar = ((ProgressBar) localView.findViewById(R.id.duration_progressbar));
            mDialogSeekTime = ((TextView) localView.findViewById(R.id.tv_current));
            mDialogTotalTime = ((TextView) localView.findViewById(R.id.tv_duration));
            mDialogIcon = ((ImageView) localView.findViewById(R.id.duration_image_tip));
            mProgressDialog = new Dialog(getContext(), R.style.player_style_dialog_progress);
    ...
    public void showVolumeDialog(float deltaY, int volumePercent) {
        ...
        if (mVolumeDialog == null) {
            ...
            mVolumeDialog = new Dialog(getContext(), R.style.player_style_dialog_progress);
    ...
    public void showBrightnessDialog(int brightnessPercent) {
        ...
        if (mBrightnessDialog == null) {
            ...
            mBrightnessDialog = new Dialog(getContext(), R.style.player_style_dialog_progress);
