...
public class PlayerUtils {
    ...
    public static void saveProgress(Context context, String url, int progress) {
        if (!WDYVideoPlayer.SAVE_PROGRESS) return;
        SharedPreferences spn = context.getSharedPreferences("WDYPlayer_PROGRESS", Context.MODE_PRIVATE);
    ...
    public static int getSavedProgress(Context context, String url) {
        if (!WDYVideoPlayer.SAVE_PROGRESS) return 0;
        SharedPreferences spn;
        spn = context.getSharedPreferences("WDYPlayer_PROGRESS", Context.MODE_PRIVATE);
    ...
    public static void clearSavedProgress(Context context, String url) {
        if (TextUtils.isEmpty(url)) {
            SharedPreferences spn = context.getSharedPreferences("JCVD_PROGRESS", Context.MODE_PRIVATE);
