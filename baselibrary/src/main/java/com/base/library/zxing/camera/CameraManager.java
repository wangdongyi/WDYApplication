...
package com.base.library.zxing.camera;
...
public final class CameraManager {
    ...
    public static void init(Context context) {
        ...
        MIN_FRAME_WIDTH = CodeUtil.dip2px(context, 240);
        MIN_FRAME_HEIGHT = CodeUtil.dip2px(context, 240);
        MAX_FRAME_WIDTH = CodeUtil.dip2px(context, 240);
        MAX_FRAME_HEIGHT = CodeUtil.dip2px(context, 240);
    }
